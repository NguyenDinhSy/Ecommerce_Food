...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateAccount() {
        ...
        if(TextUtils.isEmpty(name)){
            ...
            Validate_phoneNumber(name, phone, password); 
        }
    }

    private void Validate_phoneNumber(final String name, final String phone, final String password) {
                                 ...
                                 public void onComplete(@NonNull Task<Void> task) {
                                     ...
                                     if (task.isSuccessful()){
                                        ...
                                        loadingBar.dismiss();
                                         ...
                                         Toast.makeText(RegisterActivity.this, "Network errors",Toast.LENGTH_SHORT).show();
